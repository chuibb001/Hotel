...
@interface Room : NSObject <NSCoding> {
  ...
  NSString * __name;
  double __price;
  int32_t __availableRooms;

  BOOL __rooomId_isset;
  BOOL __name_isset;
  BOOL __price_isset;
  BOOL __availableRooms_isset;
}
...
@property (nonatomic, getter=availableRooms, setter=setAvailableRooms:) int32_t availableRooms;
#endif
...
@interface Supplies : NSObject <NSCoding> {
  int32_t __suppliesId;
  NSString * __name;
  NSString * __quantifier;
  double __onlinePrice;
  double __basePrice;

  BOOL __suppliesId_isset;
  BOOL __name_isset;
...
#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, getter=suppliesId, setter=setSuppliesId:) int32_t suppliesId;
@property (nonatomic, retain, getter=name, setter=setName:) NSString * name;
@property (nonatomic, retain, getter=quantifier, setter=setQuantifier:) NSString * quantifier;
@property (nonatomic, getter=onlinePrice, setter=setOnlinePrice:) double onlinePrice;
@property (nonatomic, getter=basePrice, setter=setBasePrice:) double basePrice;
#endif
...
@interface Hotel : NSObject <NSCoding> {
  ...
  BOOL __vacant;
  double __price;
  double __recommendScore;
  double __distance;
  BOOL __parkingAvailable;
  BOOL __wifiAvailable;
  Image * __coverImage;
  NSMutableArray * __image;
  NSString * __introduction;
  NSMutableArray * __room;
  NSMutableArray * __supplies;
  NSMutableArray * __qInfo;
  ...
  BOOL __vacant_isset;
  BOOL __price_isset;
  BOOL __recommendScore_isset;
  BOOL __distance_isset;
  BOOL __parkingAvailable_isset;
  BOOL __wifiAvailable_isset;
...
@property (nonatomic, getter=price, setter=setPrice:) double price;
@property (nonatomic, getter=recommendScore, setter=setRecommendScore:) double recommendScore;
@property (nonatomic, getter=distance, setter=setDistance:) double distance;
@property (nonatomic, getter=parkingAvailable, setter=setParkingAvailable:) BOOL parkingAvailable;
@property (nonatomic, getter=wifiAvailable, setter=setWifiAvailable:) BOOL wifiAvailable;
...
@property (nonatomic, retain, getter=room, setter=setRoom:) NSMutableArray * room;
@property (nonatomic, retain, getter=supplies, setter=setSupplies:) NSMutableArray * supplies;
@property (nonatomic, retain, getter=qInfo, setter=setQInfo:) NSMutableArray * qInfo;
#endif
