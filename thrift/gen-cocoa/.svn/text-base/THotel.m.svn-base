...
- (id) initWithRooomId: (int32_t) rooomId name: (NSString *) name price: (double) price availableRooms: (int32_t) availableRooms
{
  self = [super init];
  __rooomId = rooomId;
  __rooomId_isset = YES;
  ...
  __price = price;
  __price_isset = YES;
  __availableRooms = availableRooms;
  __availableRooms_isset = YES;
  return self;
}
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"availableRooms"])
  {
    __availableRooms = [decoder decodeInt32ForKey: @"availableRooms"];
    __availableRooms_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__availableRooms_isset)
  {
    [encoder encodeInt32: __availableRooms forKey: @"availableRooms"];
  }
}
...
- (int32_t) availableRooms {
  return __availableRooms;
}

- (void) setAvailableRooms: (int32_t) availableRooms {
  __availableRooms = availableRooms;
  __availableRooms_isset = YES;
}

- (BOOL) availableRoomsIsSet {
  return __availableRooms_isset;
}

- (void) unsetAvailableRooms {
  __availableRooms_isset = NO;
}
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 4:
        if (fieldType == TType_I32) {
          int32_t fieldValue = [inProtocol readI32];
          [self setAvailableRooms: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__availableRooms_isset) {
    [outProtocol writeFieldBeginWithName: @"availableRooms" type: TType_I32 fieldID: 4];
    [outProtocol writeI32: __availableRooms];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",availableRooms:"];
  [ms appendFormat: @"%i", __availableRooms];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (id) initWithSuppliesId: (int32_t) suppliesId name: (NSString *) name quantifier: (NSString *) quantifier onlinePrice: (double) onlinePrice basePrice: (double) basePrice
{
  self = [super init];
  __suppliesId = suppliesId;
  __suppliesId_isset = YES;
  __name = [name retain_stub];
  __name_isset = YES;
...
{
  self = [super init];
  if ([decoder containsValueForKey: @"suppliesId"])
  {
    __suppliesId = [decoder decodeInt32ForKey: @"suppliesId"];
    __suppliesId_isset = YES;
  }
  if ([decoder containsValueForKey: @"name"])
  {
  ...
  {
    __onlinePrice = [decoder decodeDoubleForKey: @"onlinePrice"];
    __onlinePrice_isset = YES;
  }
  if ([decoder containsValueForKey: @"basePrice"])
  {
    __basePrice = [decoder decodeDoubleForKey: @"basePrice"];
    __basePrice_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  if (__suppliesId_isset)
  {
    [encoder encodeInt32: __suppliesId forKey: @"suppliesId"];
  }
  if (__name_isset)
  {
    [encoder encodeObject: __name forKey: @"name"];
  ...
  {
    [encoder encodeDouble: __onlinePrice forKey: @"onlinePrice"];
  }
  if (__basePrice_isset)
  {
    [encoder encodeDouble: __basePrice forKey: @"basePrice"];
  }
}
...
- (void) setSuppliesId: (int32_t) suppliesId {
  __suppliesId = suppliesId;
  __suppliesId_isset = YES;
}

- (BOOL) suppliesIdIsSet {
  return __suppliesId_isset;
}

- (void) unsetSuppliesId {
  __suppliesId_isset = NO;
}
...
- (void) setOnlinePrice: (double) onlinePrice {
  __onlinePrice = onlinePrice;
  __onlinePrice_isset = YES;
}
...
- (BOOL) basePriceIsSet {
  return __basePrice_isset;
}

- (void) unsetBasePrice {
  __basePrice_isset = NO;
}
...
- (void) write: (id <TProtocol>) outProtocol {
  [outProtocol writeStructBeginWithName: @"Supplies"];
  if (__suppliesId_isset) {
    [outProtocol writeFieldBeginWithName: @"suppliesId" type: TType_I32 fieldID: 1];
    [outProtocol writeI32: __suppliesId];
    [outProtocol writeFieldEnd];
  }
  if (__name_isset) {
    if (__name != nil) {
  ...
  if (__onlinePrice_isset) {
    [outProtocol writeFieldBeginWithName: @"onlinePrice" type: TType_DOUBLE fieldID: 4];
    [outProtocol writeDouble: __onlinePrice];
    [outProtocol writeFieldEnd];
  }
  if (__basePrice_isset) {
    [outProtocol writeFieldBeginWithName: @"basePrice" type: TType_DOUBLE fieldID: 5];
    [outProtocol writeDouble: __basePrice];
    [outProtocol writeFieldEnd];
  }
  [outProtocol writeFieldStop];
  [outProtocol writeStructEnd];
...
- (NSString *) description {
  NSMutableString * ms = [NSMutableString stringWithString: @"Supplies("];
  [ms appendString: @"suppliesId:"];
  [ms appendFormat: @"%i", __suppliesId];
  [ms appendString: @",name:"];
  [ms appendFormat: @"\"%@\"", __name];
  [ms appendString: @",quantifier:"];
  [ms appendFormat: @"\"%@\"", __quantifier];
  [ms appendString: @",onlinePrice:"];
  [ms appendFormat: @"%f", __onlinePrice];
  [ms appendString: @",basePrice:"];
  [ms appendFormat: @"%f", __basePrice];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
...
- (id) initWithHotelId: (int32_t) hotelId name: (NSString *) name phone: (NSString *) phone address: (NSString *) address latitude: (double) latitude longitude: (double) longitude vacant: (BOOL) vacant price: (double) price recommendScore: (double) recommendScore distance: (double) distance parkingAvailable: (BOOL) parkingAvailable wifiAvailable: (BOOL) wifiAvailable coverImage: (Image *) coverImage image: (NSMutableArray *) image introduction: (NSString *) introduction room: (NSMutableArray *) room supplies: (NSMutableArray *) supplies qInfo: (NSMutableArray *) qInfo
{
  self = [super init];
  __hotelId = hotelId;
  __hotelId_isset = YES;
  ...
  __price = price;
  __price_isset = YES;
  __recommendScore = recommendScore;
  __recommendScore_isset = YES;
  __distance = distance;
  __distance_isset = YES;
  __parkingAvailable = parkingAvailable;
  __parkingAvailable_isset = YES;
  __wifiAvailable = wifiAvailable;
  __wifiAvailable_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  if ([decoder containsValueForKey: @"recommendScore"])
  {
    __recommendScore = [decoder decodeDoubleForKey: @"recommendScore"];
    __recommendScore_isset = YES;
  }
  if ([decoder containsValueForKey: @"distance"])
  {
    __distance = [decoder decodeDoubleForKey: @"distance"];
    __distance_isset = YES;
  }
  if ([decoder containsValueForKey: @"parkingAvailable"])
  {
    __parkingAvailable = [decoder decodeBoolForKey: @"parkingAvailable"];
    __parkingAvailable_isset = YES;
  }
  if ([decoder containsValueForKey: @"wifiAvailable"])
  {
    __wifiAvailable = [decoder decodeBoolForKey: @"wifiAvailable"];
    __wifiAvailable_isset = YES;
  }
  ...
  if ([decoder containsValueForKey: @"qInfo"])
  {
    __qInfo = [[decoder decodeObjectForKey: @"qInfo"] retain_stub];
    __qInfo_isset = YES;
  }
  return self;
}
...
- (void) encodeWithCoder: (NSCoder *) encoder
{
  ...
  if (__recommendScore_isset)
  {
    [encoder encodeDouble: __recommendScore forKey: @"recommendScore"];
  }
  if (__distance_isset)
  {
    [encoder encodeDouble: __distance forKey: @"distance"];
  }
  if (__parkingAvailable_isset)
  {
    [encoder encodeBool: __parkingAvailable forKey: @"parkingAvailable"];
  }
  if (__wifiAvailable_isset)
  {
    [encoder encodeBool: __wifiAvailable forKey: @"wifiAvailable"];
  }
  ...
  if (__qInfo_isset)
  {
    [encoder encodeObject: __qInfo forKey: @"qInfo"];
  }
}
...
- (double) recommendScore {
  return __recommendScore;
}

- (void) setRecommendScore: (double) recommendScore {
  __recommendScore = recommendScore;
  __recommendScore_isset = YES;
}

- (BOOL) recommendScoreIsSet {
  return __recommendScore_isset;
}

- (void) unsetRecommendScore {
  __recommendScore_isset = NO;
}
...
- (BOOL) parkingAvailable {
  return __parkingAvailable;
}

- (void) setParkingAvailable: (BOOL) parkingAvailable {
  __parkingAvailable = parkingAvailable;
  __parkingAvailable_isset = YES;
}

- (BOOL) parkingAvailableIsSet {
  return __parkingAvailable_isset;
}

- (void) unsetParkingAvailable {
  __parkingAvailable_isset = NO;
}

- (BOOL) wifiAvailable {
  return __wifiAvailable;
}
...
- (BOOL) wifiAvailableIsSet {
  return __wifiAvailable_isset;
}

- (void) unsetWifiAvailable {
  __wifiAvailable_isset = NO;
}
...
- (void) setRoom: (NSMutableArray *) room {
  [room retain_stub];
  [__room release_stub];
  __room = room;
  __room_isset = YES;
...
- (NSMutableArray *) qInfo {
  return [[__qInfo retain_stub] autorelease_stub];
}

- (void) setQInfo: (NSMutableArray *) qInfo {
  [qInfo retain_stub];
  [__qInfo release_stub];
  __qInfo = qInfo;
  __qInfo_isset = YES;
  ...
  while (true)
  {
    ...
    switch (fieldID)
    {
      ...
      case 14:
        if (fieldType == TType_DOUBLE) {
          double fieldValue = [inProtocol readDouble];
          [self setRecommendScore: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      ...
      case 17:
        if (fieldType == TType_BOOL) {
          BOOL fieldValue = [inProtocol readBool];
          [self setParkingAvailable: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      case 18:
        if (fieldType == TType_BOOL) {
          BOOL fieldValue = [inProtocol readBool];
          [self setWifiAvailable: fieldValue];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
        break;
      ...
      case 13:
        if (fieldType == TType_LIST) {
          ...
          {
            Supplies *_elem13 = [[Supplies alloc] init];
      ...
      case 16:
        if (fieldType == TType_LIST) {
          ...
          {
            int32_t _elem16 = [inProtocol readI32];
            [fieldValue addObject: [NSNumber numberWithLong: _elem16]];
          }
          [inProtocol readListEnd];
          [self setQInfo: fieldValue];
          [fieldValue release_stub];
        } else { 
          [TProtocolUtil skipType: fieldType onProtocol: inProtocol];
        }
...
- (void) write: (id <TProtocol>) outProtocol {
  ...
  if (__recommendScore_isset) {
    [outProtocol writeFieldBeginWithName: @"recommendScore" type: TType_DOUBLE fieldID: 14];
    [outProtocol writeDouble: __recommendScore];
    [outProtocol writeFieldEnd];
  }
  if (__distance_isset) {
    [outProtocol writeFieldBeginWithName: @"distance" type: TType_DOUBLE fieldID: 15];
    [outProtocol writeDouble: __distance];
    [outProtocol writeFieldEnd];
  }
  if (__parkingAvailable_isset) {
    [outProtocol writeFieldBeginWithName: @"parkingAvailable" type: TType_BOOL fieldID: 17];
    [outProtocol writeBool: __parkingAvailable];
    [outProtocol writeFieldEnd];
  }
  if (__wifiAvailable_isset) {
    [outProtocol writeFieldBeginWithName: @"wifiAvailable" type: TType_BOOL fieldID: 18];
    [outProtocol writeBool: __wifiAvailable];
    [outProtocol writeFieldEnd];
  }
  if (__coverImage_isset) {
    if (__coverImage != nil) {
  ...
  if (__image_isset) {
    if (__image != nil) {
      [outProtocol writeFieldBeginWithName: @"image" type: TType_LIST fieldID: 10];
      {
        ...
        int i18;
        for (i18 = 0; i18 < [__image count]; i18++)
        {
          [[__image objectAtIndex: i18] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__room_isset) {
    if (__room != nil) {
      [outProtocol writeFieldBeginWithName: @"room" type: TType_LIST fieldID: 12];
      {
        [outProtocol writeListBeginWithElementType: TType_STRUCT size: [__room count]];
        int i20;
        for (i20 = 0; i20 < [__room count]; i20++)
        {
          [[__room objectAtIndex: i20] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__supplies_isset) {
    if (__supplies != nil) {
      [outProtocol writeFieldBeginWithName: @"supplies" type: TType_LIST fieldID: 13];
      {
        ...
        int i22;
        for (i22 = 0; i22 < [__supplies count]; i22++)
        {
          [[__supplies objectAtIndex: i22] write: outProtocol];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
  ...
  if (__qInfo_isset) {
    if (__qInfo != nil) {
      [outProtocol writeFieldBeginWithName: @"qInfo" type: TType_LIST fieldID: 16];
      {
        [outProtocol writeListBeginWithElementType: TType_I32 size: [__qInfo count]];
        int i24;
        for (i24 = 0; i24 < [__qInfo count]; i24++)
        {
          [outProtocol writeI32: [[__qInfo objectAtIndex: i24] longValue]];
        }
        [outProtocol writeListEnd];
      }
      [outProtocol writeFieldEnd];
...
- (NSString *) description {
  ...
  [ms appendString: @",price:"];
  [ms appendFormat: @"%f", __price];
  [ms appendString: @",recommendScore:"];
  [ms appendFormat: @"%f", __recommendScore];
  [ms appendString: @",distance:"];
  [ms appendFormat: @"%f", __distance];
  [ms appendString: @",parkingAvailable:"];
  [ms appendFormat: @"%i", __parkingAvailable];
  [ms appendString: @",wifiAvailable:"];
  [ms appendFormat: @"%i", __wifiAvailable];
  ...
  [ms appendString: @",qInfo:"];
  [ms appendFormat: @"%@", __qInfo];
  [ms appendString: @")"];
  return [NSString stringWithString: ms];
}
