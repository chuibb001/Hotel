...
{
    // save data
    NSString *_contractName=contractTextField.text;
    NSString *_contractTel=phoneTextField.text;
    
    int count=counterView.count;
    
    data.contractName=_contractName;
    data.contractTel=_contractTel;
