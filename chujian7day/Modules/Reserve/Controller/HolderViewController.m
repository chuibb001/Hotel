...
-(void)setViewControler
{
    ...
    resultVC.delegate1=self;
    resultVC.delegate2=self;
...
-(void)tableClicked
{
    HotelRoomViewController *hotelVC=[[HotelRoomViewController alloc] init];
...
-(void)timeBtnClicked:(int)type
{
    ...
    timeVC.delegate=resultVC;
    [timeVC setValue:[NSString stringWithFormat:@"%d",type] forKey:@"type"];
