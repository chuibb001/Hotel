...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [ReserveData sharedReserveData].cityString=cityStr;
...
-(void)initTableView
{
    cityTableView=[[UITableView alloc] initWithFrame:CGRectMake(0, 88, 320, self.view.frame.size.height-88) style:UITableViewStylePlain];
...
-(void)initSearchBar
{
    searchBar=[[UISearchBar alloc] initWithFrame:CGRectMake(0, 44, self.view.frame.size.width, 44)];
    searchBar.delegate=self;
    //searchBar.backgroundImage=[UIImage imageNamed:@"friend_bg.png"];
